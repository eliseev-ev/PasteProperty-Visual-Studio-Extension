...
namespace PasteProperty
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ConvertSelectedToPrivateFieldCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static ConvertSelectedToPrivateFieldCommand Instance
        {
            get;
            private set;
        }
        ...
        private void ChangeText()
        {
            ...
            if (dte.ActiveDocument != null)
            {
                ...
                _myCommand.Text = $"Convert \"{text.ToShortString().ToPrivateField()}\"";
