...
namespace PasteProperty
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ConvertSelectedToFieldCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private ConvertSelectedToFieldCommand(AsyncPackage package, OleMenuCommandService commandService, InsertableList<string> values)
        {
        ...
        /// </summary>
        public static ConvertSelectedToFieldCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package, InsertableList<string> values)
        {
            ...
            Instance = new ConvertSelectedToFieldCommand(package, commandService, values);
        }
