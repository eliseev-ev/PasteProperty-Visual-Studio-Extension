...
namespace PasteProperty
{
    ...
    internal sealed class ConvertSelectedToFieldCommand
    {
        ...
        private ConvertSelectedToFieldCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new ConvertSelectedToFieldCommand(package, commandService);
        }
