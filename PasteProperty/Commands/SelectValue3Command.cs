...
namespace PasteProperty
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SelectValue3Command
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private SelectValue3Command(AsyncPackage package, OleMenuCommandService commandService, InsertableList<string> values)
        {
        ...
        /// </summary>
        public static SelectValue3Command Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package, InsertableList<string> values)
        {
            ...
            Instance = new SelectValue3Command(package, commandService, values);       
        }
        ...
        {
            _values.SetMainIndex(2);
        }

        private void ChangeText()
        {
            var value = _values.Get(2);
            if (value == null)
                return;
