...
namespace PasteProperty
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CopyValue3Command
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CopyValue3Command(AsyncPackage package, OleMenuCommandService commandService, IValueRepository valueRepository)
        {
        ...
        /// </summary>
        public static CopyValue3Command Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package, IValueRepository valueRepository)
        {
            ...
            Instance = new CopyValue3Command(package, commandService, valueRepository);       
        }
        ...
        {
            CopyPasteManager.CopySelected(_valueRepository, 2);
        }
    }
}
