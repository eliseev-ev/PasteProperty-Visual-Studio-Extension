...
namespace PasteProperty
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CopyValue2Command
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static CopyValue2Command Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package, ValueRepository valueRepository)
        {
            ...
            Instance = new CopyValue2Command(package, commandService, valueRepository);       
        }
        ...
        {
            CopyPasteManager.CopySelected(_valueRepository, 1);
        }
    }
}
