...
namespace PasteProperty
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class PasteFieldCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private PasteFieldCommand(AsyncPackage package, OleMenuCommandService commandService, IValueRepository valueRepository)
        {
        ...
        /// </summary>
        public static PasteFieldCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package, IValueRepository valueRepository)
        {
            ...
            Instance = new PasteFieldCommand(package, commandService, valueRepository);       
        }
        ...
        {
            var value = _valueRepository.GetMainValue().ToField();
