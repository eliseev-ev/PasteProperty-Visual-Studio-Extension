...
namespace PasteProperty
{
    ...
    internal sealed class PastePropertyCommand
    {
        ...
        private PastePropertyCommand(AsyncPackage package, OleMenuCommandService commandService, InsertableList<string> values)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package, InsertableList<string> values)
        {
            ...
            Instance = new PastePropertyCommand(package, commandService, values);       
        }
