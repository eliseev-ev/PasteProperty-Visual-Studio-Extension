...
namespace PasteProperty
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CopyValue1Command
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CopyValue1Command(AsyncPackage package, OleMenuCommandService commandService, IValueRepository valueRepository)
        {
        ...
        /// </summary>
        public static CopyValue1Command Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package, IValueRepository valueRepository)
        {
            ...
            Instance = new CopyValue1Command(package, commandService, valueRepository);       
        }
        ...
        {
            CopyPasteManager.CopySelected(_valueRepository, 0);
        }
    }
}
